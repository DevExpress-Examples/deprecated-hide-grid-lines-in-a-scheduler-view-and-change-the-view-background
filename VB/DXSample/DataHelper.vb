...
Namespace DXSample.ViewModels
    ...
    Friend Class DataHelper
        ...
        Public Shared Function GetResources() As ObservableCollection(Of ResourceViewModel)
            Dim collection As ObservableCollection(Of ResourceViewModel) = New ObservableCollection(Of ResourceViewModel)() From {New ResourceViewModel() With {.Id = 1, .Caption = "Work"}, New ResourceViewModel() With {.Id = 2, .Caption = "Personal"}}
            Return collection
        End Function
    End Class
End Namespace
